...
keywords: gemcutter api, gemcutter cli, gemcutter console, search gems, gemcutter commandline, gemcutter shell, gemcutter search, boson api, build gemcutter api, boson commandline
description: Gemcutter <a href="http://update.gemcutter.org/2010/02/01/january-changelog.html">recently added</a> a search call to <a href="http://gemcutter.org/pages/api_docs">its api</a>. With gemcutter's api and <a href="http://github.com/cldwalker/boson">boson</a>, let's see what we can do on the commandline.
tags:
- post:type=tutorial
- post:lang=ruby
- gem:name=boson
...
Now, if you want to use these commands but with shorter command names or different default fields displayed, "you should read":/2009/10/14/boson-command-your-ruby-universe.html#just_alias_it "up on boson":/2009/11/21/boson-command-your-ruby-universe-part-deux.html#social_libraries.
...
As you've seen, we took a one-line api call and configured it with "boson":http://github.com/cldwalker/boson to make a useful CLI to gemcutter. If you're interested in more APIs I've wrapped with boson, I'd recommend looking at "github":/2009/10/15/boson-and-hirb-interactions.html#github_boson_library or anything under "here":http://github.com/cldwalker/irbfiles/blob/master/boson/commands/public/site. And if you don't already know, we can drive any of these api calls in irb thanks to "boson's shell/irb duality":/2009/10/14/boson-command-your-ruby-universe.html#shell_and_irb_duality.