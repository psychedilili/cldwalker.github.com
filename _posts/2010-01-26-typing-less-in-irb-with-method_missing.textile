...
description: Being the efficiency prick I am, let's look at a @method_missing@ that let's us type less where underscored methods are involved. This means that instead of typing @some_really_long_ass_method@ we can type @s_r_l_a_s@.
tags:
