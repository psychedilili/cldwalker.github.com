...
<notextile><pre class="console">
  ...
  >> require 'boson'; Boson.start :verbose=>true
  Loaded library core
...
To start using third-party Boson libraries, "check mine out":http://github.com/cldwalker/irbfiles. Note that some of libraries depend on other libraries. Currently, installing via a url won't pick up those dependencies.
