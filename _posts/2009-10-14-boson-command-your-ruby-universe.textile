...
To start using third-party Boson libraries, "check mine out":http://github.com/cldwalker/irbfiles. Note that some of libraries depend on other libraries which the install doesn't yet pick up.
