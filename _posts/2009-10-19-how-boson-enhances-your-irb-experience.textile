...
"Boson::ModuleLibrary":http://tagaholic.me/boson/doc/classes/Boson/ModuleLibrary.html simply makes commands from a class or module's class methods:
...
In this post, we've seen how Boson treats methods like shell commands. In doing so, it makes irb (or any ruby console) a shell you can easily customize. For more traditional ruby shell implementations, see "rubish":http://github.com/hayeah/rubish/, "rush":http://github.com/adamwiggins/rush and "pope":http://www.creo.hu/~csaba/ruby/pope/. If you're interested in giving autocompletion to your commands, check out "Bond":/2009/07/16/bond-from-irb-with-completion-love.html.